...
def test_classic_minrisk_optimization():
    ...
    rms = ['MV', 'MAD', 'GMD', 'MSV', 'FLPM', 'SLPM', 'CVaR', 'TG', 'EVaR',
    ...
    np.testing.assert_array_almost_equal(w_1.to_numpy(),
                                         w_2.to_numpy(),
                                         decimal=6)
...
def test_classic_riskparity_optimization():
    ...
    rms = ['MV', 'MAD', 'GMD', 'MSV', 'FLPM', 'SLPM', 'CVaR',
           'TG', 'CVRG', 'TGRG', 'EVaR', 'CDaR', 'EDaR', 'UCI']
