...
- The Black Litterman model that allows to incorporate analyst's views on assets' returns in estimates of vector of means and covariance matrix :cite:`b-BlackLitterman`, :cite:`b-Black1`.
- The Augmented Black Litterman model that allows to incorporate analyst's views on risk factors in estimates of vector of means and covariance matrix :cite:`b-Cheung2007`.
...
- The Entropy Pooling model that allows to incorporate analyst's views on assets' returns in estimates of vector of means, covariance matrix, coskewness tensor and cokurtosis matrix :cite:`b-Meucci2010`, :cite:`b-Alexandersson2021`.
