############################################
Riskfolio-XL: Riskfolio-Lib add-in for Excel
############################################
...
Riskfolio-XL is a Microsoft Excel add-in based on `PyXLL <https://www.pyxll.com/index.html>`_ library, 
that allows users use the same features of Riskfolio-Lib in Excel through Riskfolio-XL spreadsheet 
functions. Its objective is to help non-programming users to build investment portfolios based on 
mathematically complex models with low effort and to support the maintenance and further development 
of Riskfolio-Lib.
